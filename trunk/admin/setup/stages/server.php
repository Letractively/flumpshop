...
$section = 'server';
?><script>parent.leftFrame.window.location = '../?frame=leftFrame&p=3.10';</script>
<h1>Advanced Server Settings</h1>
<form action="../process/doServer.php" method="post"><table><?php
