...
INSERT INTO `country` (`iso`, `name`, `supported`, `currency`) VALUES('PW', 'Palau', 0, 'EUR');
INSERT INTO `country` (`iso`, `name`, `supported`, `currency`) VALUES('PY', 'Paraguay', 0, 'EUR');
INSERT INTO `country` (`iso`, `name`, `supported`, `currency`) VALUES('QA', 'Qatar', 0, 'EUR');
INSERT INTO `country` (`iso`, `name`, `supported`, `currency`) VALUES('RE', 'Reunion', 0, 'EUR');
INSERT INTO `country` (`iso`, `name`, `supported`, `currency`) VALUES('RO', 'Romania', 0, 'EUR');
INSERT INTO `country` (`iso`, `name`, `supported`, `currency`) VALUES('RU', 'Russian Federation', 0, 'EUR');
INSERT INTO `country` (`iso`, `name`, `supported`, `currency`) VALUES('RW', 'Rwanda', 0, 'EUR');
INSERT INTO `country` (`iso`, `name`, `supported`, `currency`) VALUES('SA', 'Saudi Arabia', 0, 'EUR');
INSERT INTO `country` (`iso`, `name`, `supported`, `currency`) VALUES('SB', 'Solomon Islands', 0, 'EUR');
