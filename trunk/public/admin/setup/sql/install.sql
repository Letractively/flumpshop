...
CREATE TABLE `config_values` (
  `config_set` int(3) unsigned NOT NULL,
  `config_tree` varchar(15) NOT NULL,
  `config_key` varchar(25) NOT NULL,
  `config_value` TEXT NOT NULL,
  PRIMARY KEY (`config_set`, `config_tree`, `config_key`)
);

CREATE TABLE `config_values_human` (
  `config_tree` varchar(15) NOT NULL,
  `config_key` varchar(25) DEFAULT NULL,
  `config_human_name` varchar(75) NOT NULL DEFAULT 'Description Unavailable',
  `config_human_description` TEXT NOT NULL
    DEFAULT 'No help information is available for this configuration attribute',
  PRIMARY KEY (`config_tree`, `config_key`)
);
