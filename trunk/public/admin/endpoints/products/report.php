...
?><div id='navbar'>
	...
	<a href="csv_report.php?<?php echo $_SERVER['QUERY_STRING'];?>" style="display:inline-block"><span class="ui-icon ui-icon-disk"></span>Generate CSV</a>
</div>
<h1>Product Report</h1>
<div id="options_container">
<div class="ui-widget-header" onclick="$('#options').toggle('blind');">Customise...</div>
<form action="report.php" method="GET" id="options" style="display:none;" class="ui-widget-content">
<table>
	<tr>
