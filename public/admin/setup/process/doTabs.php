...
/**
 *  This file is the Controller that process the data from the tabs stage
 ...
 *
 *
 *  @Name public/admin/setup/process/doTabs.php
 *  @Version 2.00
...
$next_stage = getNextStage(14);
$falsify_keys = array('homeTab', 'loginTab');
/*
