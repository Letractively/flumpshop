...
?>
<form action="./endpoints/process/insertNews.php" method="post" onsubmit="if ($(this).valid()) {$(this).ajaxSubmit({target: '#adminContent'});} return false;">
	<fieldset class="ui-widget">
        ...
        <input type="submit" value="Add News Post" class="ui-widget-content" />
    </fieldset>
</form>