...
?><div class="ui-widget">
    ...
    <div class="ui-widget-content">
        ...
        <a href="javascript:void(0);" onclick="loader(loadMsg('Loading Content...'));window.location = 'listOrders.php?filter=customer&id=<?php echo $customer->getID(); ?>';">Orders by this User</a>
    </div>
</div>