...
if (!acpusr_validate("can_edit_pages")) die();
...
$msg = '<div class="ui-state-highlight"><span class="ui-icon ui-icon-circle-check"></span>Featured Items Saved</div>';
header("Location: ../switchboard/products.php?msg=".$msg);
?>