<?php
	...
	********************************************/
	...
	$SandboxFlag = !$config->getNode('server','commitPayments');
	...
	$API_UserName = $config->getNode('paypal','uname');
	$API_Password = $config->getNode('paypal','pass');
	$API_Signature = $config->getNode('paypal','apiKey');
	...
	*/
	function RedirectToPayPal ( $token )
	{
		...
		echo "<script type='text/javascript'>window.location.href = '$payPalURL';</script>";
	}
